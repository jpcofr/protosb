...
int main(int argc, char *argv[])
{
  ...
  for (i = 1; i <= num; i++)
  {
    ...
    if ((hp = gethostbyname(argv[2])) == NULL)
    {
      ...
      bcopy(hp->h_addr_list[0], &ip->ip_dst.s_addr, hp->h_length); //TODO Replace this for memcpy(3) or memmove(3)
    ...
    if ((hp2 = gethostbyname(argv[1])) == NULL)
    {
      ...
      bcopy(hp2->h_addr_list[0], &ip->ip_src.s_addr, hp->h_length); //TODO Replace this for memcpy(3) or memmove(3)
